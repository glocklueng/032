...
CY_ISR_PROTO(`$INSTANCE_NAME`_I2C_ISR);
    ...
    #define `$INSTANCE_NAME`_I2C_MIN_UINT16(a, b)           ( ((uint16)(a) < (uint16) (b)) ? \
                                                                    ((uint32) (a)) : ((uint32) (b)) )
...
#define `$INSTANCE_NAME`_I2C_MSTR_ERR_ARB_LOST      (0x01u)  /* Master lost arb: INTR_MASTER_I2C_ARB_LOST             */
...
#define `$INSTANCE_NAME`_I2C_MSTR_ERR_BUS_ERR       (0x100u) /* Bus eror has: INTR_MASTER_I2C_BUS_ERROR               */
...
#define `$INSTANCE_NAME`_I2C_SSTAT_RD_OVFL          (0x04u)    /* Read overflow: master reads above buf size   */
...
#define `$INSTANCE_NAME`_I2C_SSTAT_WR_OVFL          (0x40u)    /* Write overflow: master writes above buf size  */
...
/* Return TRUE if `$INSTANCE_NAME`_MODE_NO_STOP is set in `$INSTANCE_NAME`_mstrControl: used to detect NoStop cond */
...
***************************************/
    ...
    #define `$INSTANCE_NAME`_I2C_DEFAULT_CTRL \
                                (`$INSTANCE_NAME`_GET_CTRL_ADDR_ACCEPT(`$INSTANCE_NAME`_I2C_ACCEPT_ADDRESS) | \
                                 `$INSTANCE_NAME`_GET_CTRL_EC_AM_MODE (`$INSTANCE_NAME`_I2C_WAKE_ENABLE))

    #define `$INSTANCE_NAME`_I2C_DEFAULT_I2C_CTRL \
                                (`$INSTANCE_NAME`_GET_I2C_CTRL_HIGH_PHASE_OVS(`$INSTANCE_NAME`_I2C_OVS_FACTOR_HIGH) | \
                                 `$INSTANCE_NAME`_GET_I2C_CTRL_LOW_PHASE_OVS (`$INSTANCE_NAME`_I2C_OVS_FACTOR_LOW)  | \
                                 `$INSTANCE_NAME`_GET_I2C_CTRL_SL_MSTR_MODE  (`$INSTANCE_NAME`_I2C_MODE)            | \
    ...
    #define `$INSTANCE_NAME`_I2C_DEFAULT_RX_CTRL \
                                (`$INSTANCE_NAME`_GET_RX_CTRL_MEDIAN(`$INSTANCE_NAME`_I2C_MEDIAN_FILTER_ENABLE) | \
    ...
    #define `$INSTANCE_NAME`_I2C_DEFAULT_INTR_SLAVE_MASK    ((`$INSTANCE_NAME`_I2C_SLAVE) ? \
                                                                (`$INSTANCE_NAME`_I2C_INTR_SLAVE_MASK) : (0u))
