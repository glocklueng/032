...
// due to the way i wired up the prototypes, the ports are split
#define MMA_PORTa PORTA
#define MMA_DIRa  DDRA
#define MMA_INa   PINA


// is on PORTD0
#define MMA_SCK  (1<<0)  // CLK  SCL/SPC clock signal PD1 (20)

// is on PORTD1
#define MMA_MOSI (1<<1)  // mosi sda/sdi/sdo master out,slave in PD2 (19)
...
// Not used
//	#define MMA_IRQ  (1<<5) // INT0 (PD0) (21)
