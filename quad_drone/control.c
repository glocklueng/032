...
float x_Igain = 0.0006f;        // X-Axis - I Gain - 0.01
float x_Dgain = 85.0f;          // X-Axis - D Gain - 85.0
...
// Z-Axis Data
float z_thrust = 76530.0f;      // Z Axis Thrust  // 76530.0
//
...
{ 
    ...
    x_Iterm = ((x_Igain*x_angle_error) + x_Iterm) * 0.99999f;
    ...
    y_Iterm = ((y_Igain*y_angle_error) + y_Iterm) * 0.99999f;
