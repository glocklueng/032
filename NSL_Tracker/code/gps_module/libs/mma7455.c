...
#define MMA_PORT PORTA
#define MMA_DIR  DDRA
#define MMA_IN   PINA


// is on PORTA3
#define MMA_SCK  (1<<3)  // CLK  SCL/SPC clock signal PA3 (75)

// is on PORTA4
#define MMA_MOSI (1<<4)  // mosi sda/sdi/sdo master out,slave in PA4 (74)


// is on PORTA5
#define MMA_SS   (1<<5) // (CSn of the MMA can also be connected to GND permanently.) PA5 (73)

// is on PORTA0
#define MMA_MISO (1<<0)  // miso SDO PD3 (78)

// Not used PA1
#define MMA_IRQ  (1<<1) // INT0 (PA1) (77)

uint16_t eepromWord __attribute__((section(".eeprom")));

static void swspi_init()
{
    MMA_DIR |= MMA_SCK | MMA_MOSI;
