...
/*      Share buffer between CH1 and CH2
        ...
        Use pointer for MOVE- MOVE+ menus
		USE NVM functions from BOOT */
// TODO When 64k parts come out:
/*      Gain Calibration
        How fast is the SPI sniffer?
        FFT waterfall
        Share memory buffer ch1 ch2
        Setting profiles
...
int main(void) {
    ...
    USARTD0.BAUDCTRLA = 0x01;   // BSEL=1 (SPI clock = 8MHz, SSD1306 max is 10MHz)
