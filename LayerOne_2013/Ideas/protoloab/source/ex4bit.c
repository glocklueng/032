...
const unsigned char CRC16_LookupHigh[16] PROGMEM = {
        0x00, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70,
        0x81, 0x91, 0xA1, 0xB1, 0xC1, 0xD1, 0xE1, 0xF1 };

const unsigned char CRC16_LookupLow[16] PROGMEM = {
...
void CRC16_Update4Bits(unsigned char val) {
	...
	CRC16_High = CRC16_High ^ pgm_read_byte_near(CRC16_LookupHigh+t);
	CRC16_Low = CRC16_Low ^ pgm_read_byte_near(CRC16_LookupLow+t);
}
