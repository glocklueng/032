...
#define StripLights_IRQ_Enable() CyIntEnable(StripLights_IRQ__INTC_NUMBER ); 
#define StripLights_IRQ_Disable() CyIntDisable(StripLights_IRQ__INTC_NUMBER );
CY_ISR_PROTO(StripLights_ISR);
...
#define StripLights_GREEN       getColor(5)
...
#define StripLights_SPRING_GREEN getColor((64 + StripLights_CWHEEL_SIZE)) 
#define StripLights_TURQUOSE    getColor((65 + StripLights_CWHEEL_SIZE)) 
#define StripLights_CYAN        getColor((66 + StripLights_CWHEEL_SIZE)) 
#define StripLights_OCEAN       getColor((67 + StripLights_CWHEEL_SIZE)) 
#define StripLights_VIOLET      getColor((68 + StripLights_CWHEEL_SIZE)) 
#define StripLights_RASPBERRY   getColor((69 + StripLights_CWHEEL_SIZE)) 
