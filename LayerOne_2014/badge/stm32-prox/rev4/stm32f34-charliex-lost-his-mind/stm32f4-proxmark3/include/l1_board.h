...
#define GPIOB_OUTPUTS_2MHZ_PP_MASK		( DC_PIN | RES_PIN | USB_DISCONNECT_PIN |				\
						CS_PIN | FPGAON_PIN  | MUXSEL_HIRAW_PIN | MUXSEL_LORAW_PIN )
#else
...
#if BOARD_REVISION == 3
#define GPIOC_OUTPUTS_2MHZ_PP_MASK		(MUXSEL_HIPKD_PIN  | MUXSEL_LOPKD_PIN | RELAY_PIN |SDDO_PIN | SDCS_PIN)
#else
#define GPIOC_OUTPUTS_2MHZ_PP_MASK		(   |SDDO_PIN | SDCS_PIN)

#endif

#define GPIOC_OUTPUTS_10MHZ_PP_MASK		( SPEAKER_PIN | SDSCK_PIN | NCS_PIN | MOSI_PIN |SPCK_PIN )
