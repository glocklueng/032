...
#include <proxmark3.h>			/* Include hardware specific declareation file here */

#define bset 		HIGH
#define bclr 		LOW
#define btest 		GETBIT

#define P0		GPIO_SD_CS	// CS
#define P1		GPIO_SD_SCLK	// SCLK
#define P2		GPIO_SD_MISO	// MISO
#define P3		GPIO_SD_MOSI	// MOSI
...
DSTATUS disk_initialize (BYTE b)
{
	BYTE n, cmd, ty, buf[4];
	UINT tmr;
