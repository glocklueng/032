...
static void xUsbPacketReceived(BYTE *packet, int len)
{
	uint32_t sr;
	int i, dont_ack=0;
...
void xLowLevelInit(void)
{
   ...
   //BOARD_RemapRam();
    ...
    AT91C_BASE_RTTC->RTTC_RTMR &= (AT91_REG)~(AT91C_RTTC_ALMIEN | AT91C_RTTC_RTTINCIEN);
    AT91C_BASE_PITC->PITC_PIMR &= (AT91_REG)~AT91C_PITC_PITIEN;
}
...
void LowLevelInit(void)
{
    ...
    volatile AT91_REG dbgu;
    


#ifdef _DEBUG
    dbgu = AT91C_BASE_DBGU->DBGU_CIDR | 0xf00 ;
#endif
