...
#define GPIO_LED_A				GPIO_LCD_BL
#define GPIO_LED_B				GPIO_LCD_BL
#define GPIO_LED_C				GPIO_LCD_BL
#define GPIO_LED_D				GPIO_LCD_BL

// LDO control
#define GPIO_NVDD_ON			AT91C_PIO_PA26
