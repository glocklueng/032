...
static void BuildSysInfoRequest(uint8_t *uid)
{
	uint8_t cmd[12];
...
// do not use; has a fix UID
static void BuildReadMultiBlockRequest(uint8_t *uid)
{
	uint8_t cmd[14];
...
// do not use; has a fix UID
static void BuildArbitraryRequest(uint8_t *uid,uint8_t CmdCode)
{
	uint8_t cmd[14];
...
// do not use; has a fix UID
static void BuildArbitraryCustomRequest(uint8_t uid[], uint8_t CmdCode)
{
	uint8_t cmd[14];
