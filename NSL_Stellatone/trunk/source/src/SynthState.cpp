...
void SynthState::buttonPressed(int button) {
    ...
    // int oldMenuSelect = fullState.menuSelect;
    MenuState oldMenuState = MAIN_MENU;
	
	if ( fullState.currentMenuItem ) 
		oldMenuState = fullState.currentMenuItem->menuState;
	
	_RPT1(_CRT_WARN,"button=%d\n",button);
    ...
    if (fullState.currentMenuItem && oldMenuState != fullState.currentMenuItem->menuState) {
